            ...
            {currentStep === 4 && (
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="notes" placeholder="Any additional information about the documents..." rows={3} />
                </div>
              </div>
            )}
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="h-48 rounded-lg border-2 border-dashed border-border flex items-center justify-center bg-muted/30">
                    <div className="text-center">
                      ...
                      <p className="text-muted-foreground">Click or tap to draw signature</p>
                    </div>
                  </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/50">
                  ...
                  <Label htmlFor="consent" className="text-sm leading-relaxed cursor-pointer">
                    I confirm that all the information provided is accurate and complete. I authorize the collection
                    and verification of this data for farmer registration purposes.
                  </Label>
                </div>
              </div>
            )}
